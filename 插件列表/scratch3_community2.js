...
(function (Scratch) {
    ...
    if (!Scratch.extensions.unsandboxed) {
        throw new Error(`
            "Scratch3CommunityBlocks" must be loaded in a unsandboxed environment.
        `);
    }
...
class Scratch3CommunityBlocks {
    ...
    */
    ...
    ale(url) {
        alert(markdownToHtml(url.TEXT), markdownToHtml(url.title) || '');
    }
    aleAndWait(url) {
    ...
    */
    ...
    Scratch.extensions.register(new Scratch3CommunityBlocks());
})(Scratch);